...
-- ============================================================
-- 1. ADMIN ACCOUNTS (DEDICATED DATABASE / TABLE)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS app_configs (
    ...
    CONSTRAINT uq_config_category_key UNIQUE(category, key)
);
...
CREATE INDEX IF NOT EXISTS idx_admins_login_id
    ON admins(login_id);
